...
export function getInvoiceCode(batch: Pick<InvoiceBatch, "id">): string {
  return `INV-${String(batch.id).padStart(3, "0")}`;
}
      ...
      <table className="w-full border-collapse text-sm">
        <tbody>
          ...
          <tr className="border-b border-border">
            ...
            <td className="py-2 px-3 text-right font-heading text-foreground">{batch.status === "In Progress" ? "~" : batch.food}</td>
          </tr>
          <tr className="border-b border-border">
            ...
            <td className="py-2 px-3 text-right font-heading text-foreground">{batch.status === "In Progress" ? "~" : `${batch.fees} USD`}</td>
          </tr>
      ...
      <div className="px-4 pt-4 pb-3 sm:px-6 sm:pt-6 sm:pb-4">
        ...
        <div className="flex items-start justify-between gap-4 pb-4 border-b-2 border-border">
          <div className="min-w-0">
            <h3 className="text-lg sm:text-xl font-heading text-foreground truncate">Invoice #{invoiceCode}</h3>
    ...
    <div className="bg-white border border-border rounded-base overflow-hidden">
      <div className="p-3 sm:p-4">
        ...
        <div className="flex items-start justify-between gap-3 pb-3 border-b-2 border-border">
          <div className="min-w-0">
            <h3 className="text-base font-heading text-foreground truncate">Invoice #{invoiceCode}</h3>
          </div>
          <div className="text-right shrink-0">
