        ...
        <div className="px-3 sm:px-4 lg:px-6">
          <div className="flex h-14 items-center justify-between">
            ...
            <div className="hidden md:flex md:items-center md:h-full md:gap-2">
              {telegram && (
                <Button variant="noShadow" size="icon" className="h-7 w-7 border-[1px] border-black bg-[#0088CC] text-white hover:bg-[#0077b3] hover:border-black" asChild>
              ...
              {twitter && (
                <Button variant="noShadow" size="icon" className="h-7 w-7 border-[1px] border-black bg-black text-white hover:bg-gray-800 hover:border-gray-800" asChild>
        ...
        >
          <div className="space-y-1 px-4 pb-3 pt-2">
            ...
            <div className="flex gap-2 mt-2">
              {telegram && (
                <Button variant="noShadow" size="icon" className="flex-1 h-7 border-[1px] border-black bg-[#0088CC] text-white hover:bg-[#0077b3] hover:border-black" asChild>
                  <a href={telegram} target="_blank" rel="noopener noreferrer" aria-label="Telegram">
              ...
              {twitter && (
                <Button variant="noShadow" size="icon" className="flex-1 h-7 border-[1px] border-black bg-black text-white hover:bg-gray-800 hover:border-gray-800" asChild>
                  <a href={twitter} target="_blank" rel="noopener noreferrer" aria-label="X">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 mx-auto">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                    </svg>
